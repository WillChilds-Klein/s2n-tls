...
const struct s2n_kem_group *pq_kem_groups_r3_kyber512[] = {
    &s2n_secp256r1_kyber_512_r3,
};

const struct s2n_kem_group *pq_kem_groups_r3_kyber768[] = {
    &s2n_secp384r1_kyber_768_r3,
};
...
const struct s2n_kem_preferences kem_preferences_pq_tls_1_3_kyber512 = {
    .kem_count = 0,
    .kems = NULL,
    .tls13_kem_group_count = s2n_array_len(pq_kem_groups_r3_kyber512),
    .tls13_kem_groups = pq_kem_groups_r3_kyber512,
    .tls13_pq_hybrid_draft_revision = 5
};

const struct s2n_kem_preferences kem_preferences_pq_tls_1_3_kyber768 = {
    .kem_count = 0,
    .kems = NULL,
...
const struct s2n_kem_preferences kem_preferences_pq_tls_1_3_kyber1024 = {
    .kem_count = 0,
    .kems = NULL,
    .tls13_kem_group_count = s2n_array_len(pq_kem_groups_r3_kyber1024),
    .tls13_kem_groups = pq_kem_groups_r3_kyber1024,
    .tls13_pq_hybrid_draft_revision = 5
};
